...
public class FavouiteContacts extends Fragment {
    ...
    ListView sellerlist;
    ArrayList<FavouriteContactData> seller_data = null;
    FavouriteContactAdapter selleradapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        seller_data = new ArrayList<FavouriteContactData>();
                ...
                save.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST,
                                UrlConstant.POST_Favourite_Contact, data_jobject,
...
//        getActivity().setTitle("USE");
    ...
    public void getFavouriteContact(String id) {
        JsonArrayRequest req = new JsonArrayRequest(UrlConstant.GET_Favourite_Contact + id,
